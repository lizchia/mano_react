      ...
      {display ? (
          ...
          <div className={isToggle ? 'burgerBar-show' : 'burgerBar-hide'}>
            {locationPathname === '/membercenter' ? (
              <AiOutlineMenu
                ...
                className={
                  isToggle
                    ? 'burgerBar-show-btn cGreen hover-op'
                    : 'burgerBar-hide-btn cWhite hover-op'
                }
              />
            ) : (
              <AiOutlineMenu
                ...
                className={
                  isToggle
                    ? 'burgerBar-show-btn cGreen hover-op'
                    : 'burgerBar-hide-btn cGreen hover-op'
                }
              />
            )}
            ...
            <ul
              className={
                isToggle
                  ? 'd-flex burgerBar-lists'
                  : 'd-flex burgerBar-lists barLists-disNone'
              }
            >
              <li
                className={
                  active === 'mall'
                    ? 'burgerListTitle titleActive'
                    : 'burgerListTitle'
                }
                onClick={() => {
                  setLists([
                    ...
                    {
                      name: '抹の食品 / To Eat',
                      url: '/mall/shop/cuisine?categoryId=3',
                    },
                    {
                      name: '抹の衣著 / To Wear',
                      url: '/mall/shop/clothes?categoryId=4',
                    },
                    {
                      name: '抹の生活 / To Live',
                      url: '/mall/shop/goods?categoryId=5',
                    },
                  ])
                  setActive('mall')
                }}
            ...
            <ul
              className={
                isToggle
                  ? 'mt-5 burgerBar-lists'
                  : 'mt-5 burgerBar-lists barLists-disNone'
              }
            >
        ...
        <>
          <div style={{ position: 'relative' }}>
            {locationPathname === '/membercenter' ? (
              <AiOutlineMenu
                style={{ position: 'absolute', top: '17px', left: '2vw' }}
